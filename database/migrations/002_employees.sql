-- ============================================================
-- Migration 002 - Employes, roles, notifications
-- Idempotente: compatible avec docker-entrypoint-initdb.d
-- ============================================================
...
VALUES
    ('a0000000-0000-0000-0000-000000000001', 'transaction_confirmed', 'Paiement recu', 'Wave - 2 500 FCFA confirme', '{"amount": 2500, "provider": "wave"}'),
    ('a0000000-0000-0000-0000-000000000001', 'daily_summary', 'Bilan de la journee', 'Vous avez encaisse 7 500 FCFA en 3 transactions aujourd''hui.', '{"total": 7500, "count": 3}'),
    ('a0000000-0000-0000-0000-000000000001', 'employee_login', 'Connexion employe', 'Fatou Diop s''est connectee a 09:14', '{"employee_name": "Fatou Diop"}');
